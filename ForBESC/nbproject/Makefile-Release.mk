...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/forbesc: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/forbesc ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/_ext/529256040/ForBESUtils.o: /home/chung/Documents/MATLAB/ForBES/ForBESC/ForBESUtils.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/529256040/ForBESUtils.o /home/chung/Documents/MATLAB/ForBES/ForBESC/ForBESUtils.cpp

${OBJECTDIR}/_ext/529256040/QuadOverAffine.o: /home/chung/Documents/MATLAB/ForBES/ForBESC/QuadOverAffine.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/529256040
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/529256040/QuadOverAffine.o /home/chung/Documents/MATLAB/ForBES/ForBESC/QuadOverAffine.cpp
...
${OBJECTDIR}/MatrixFactory.o: MatrixFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MatrixFactory.o MatrixFactory.cpp
...
${TESTDIR}/tests/TestMatrix.o: tests/TestMatrix.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestMatrix.o tests/TestMatrix.cpp


${TESTDIR}/tests/TestMatrixRunner.o: tests/TestMatrixRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestMatrixRunner.o tests/TestMatrixRunner.cpp


${TESTDIR}/tests/TestMatrixFactory.o: tests/TestMatrixFactory.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestMatrixFactory.o tests/TestMatrixFactory.cpp


${TESTDIR}/tests/TestMatrixFactoryRunner.o: tests/TestMatrixFactoryRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestMatrixFactoryRunner.o tests/TestMatrixFactoryRunner.cpp


${TESTDIR}/tests/TestQuadratic.o: tests/TestQuadratic.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestQuadratic.o tests/TestQuadratic.cpp


${TESTDIR}/tests/TestQuadraticRunner.o: tests/TestQuadraticRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestQuadraticRunner.o tests/TestQuadraticRunner.cpp
...
${OBJECTDIR}/_ext/529256040/ForBESUtils_nomain.o: ${OBJECTDIR}/_ext/529256040/ForBESUtils.o /home/chung/Documents/MATLAB/ForBES/ForBESC/ForBESUtils.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/529256040/ForBESUtils_nomain.o /home/chung/Documents/MATLAB/ForBES/ForBESC/ForBESUtils.cpp;\
	else  \
...
${OBJECTDIR}/_ext/529256040/QuadOverAffine_nomain.o: ${OBJECTDIR}/_ext/529256040/QuadOverAffine.o /home/chung/Documents/MATLAB/ForBES/ForBESC/QuadOverAffine.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/529256040/QuadOverAffine_nomain.o /home/chung/Documents/MATLAB/ForBES/ForBESC/QuadOverAffine.cpp;\
	else  \
...
${OBJECTDIR}/Matrix_nomain.o: ${OBJECTDIR}/Matrix.o Matrix.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Matrix_nomain.o Matrix.cpp;\
	else  \
...
${OBJECTDIR}/MatrixFactory_nomain.o: ${OBJECTDIR}/MatrixFactory.o MatrixFactory.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MatrixFactory_nomain.o MatrixFactory.cpp;\
	else  \
...
${OBJECTDIR}/Quadratic_nomain.o: ${OBJECTDIR}/Quadratic.o Quadratic.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Quadratic_nomain.o Quadratic.cpp;\
	else  \
